...
class FCGAT(nn.Module):
    def __init__(self, n_input_features, n_hidden_features1, n_hidden_features2, n_output_features, dropout, alpha, n_heads1, n_heads2):
        ...
        self.out_att = FCGraphAttentionLayer(n_hidden_features2 * n_heads2, n_output_features, dropout=dropout, alpha=alpha, concat=False)
